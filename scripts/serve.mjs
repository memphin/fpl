...
// The browser bundle, including its JSON snapshots, is generated in public/.
// Serving the repository root leaves /assets/*.json unavailable and causes the
// fixture and prediction pages to fail during startup.
...
}).listen(port, () => console.log(`Fixture Lens public preview is running at http://localhost:${port}`));
