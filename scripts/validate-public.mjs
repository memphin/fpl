...
const [privateFixtures, privatePlayers, playerMatches, publicFixtures, publicPlayers, publicLineups] = await Promise.all([
...
if (/https?:\/\/|checkedAt|reviewedAt|projectedMinutes|predictedPoints/i.test(publicLineupText)) fail('Public lineups contain private research or raw prediction fields.');
